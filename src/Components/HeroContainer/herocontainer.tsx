      ...
      <div className="flex flex-col w-full h-3/5 items-center gap-2">
        ...
        <div className="h-full w-full mt-8">
          <div className="flex flex-row w-full h-full items-start justify-center gap-4">
            ...
            <Alert variant="light" color="blue" className="w-2/5">
              <p className="text-lg">
              At Clover academy our experienced faculty try not only to bridge the gap between individual abilities 
                and academic curriculum; one of our major goal is to prepare the young budding minds to meet upcoming 
                challenges and sudden changes that may cross their academic path. Our comprehensive curriculum 
                encompasses US common core, O level and Singapore A level syllabus including preparedness towards 
                mathematics, and science olympiad. We emphasize strongly on one to one interaction between students 
                and teacher. Our aim is to prepare our students towards academic excellence and college readiness 
                with intellectual and emotional support.
              </p>
            </Alert>
